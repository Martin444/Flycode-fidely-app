          ...
          child: Center(
            child: AnimatedBuilder(
              ...
              builder: (context, body) {
                return Container(
                    width:
                        Get.width / 4.5 - _controller.value.clamp(0, 35) * 10,
                    height:
                        Get.height / 4.5 - _controller.value.clamp(0, 35) * 10,
          ...
          child: Center(
            child: AnimatedBuilder(
              ...
              builder: (context, body) {
                return Container(
                    width:
                        Get.width / 5.4 - _controller.value.remainder(15) * 10,
                    height:
                        Get.height / 5.4 - _controller.value.remainder(15) * 10,
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: Colors.white.withOpacity(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(
                ...
                color: FlColors.primaryColorsBackground,
              ),
            ),
          ),
        ),
